...
public class TextFileOpenTool implements ToolCallBiFunctionDef {

    private static final Logger log = LoggerFactory.getLogger(TextFileOpenTool.class);
    ...
    public TextFileOpenTool(String workingDirectoryPath, TextFileService textFileService) {
    ...
    private final String TOOL_NAME = "text_file_opener";

    private final String TOOL_DESCRIPTION = """
			对文本文件（包括 md、html、css、java 等）执行打开操作
    ...
    public FunctionToolCallback getFunctionToolCallback(String workingDirectoryPath, TextFileService textFileService) {
        return FunctionToolCallback.builder(TOOL_NAME, new TextFileOpenTool(workingDirectoryPath, textFileService))
    ...
    public ToolExecuteResult run(String toolInput) {
        ...
        try {
            ...
            return openFile(planId, filePath);
        }
        catch (Exception e) {
            String planId = this.planId;
